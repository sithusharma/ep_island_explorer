...
const downtown: Entity[] = [
  officeBldg("city-center", 500, 988, 110, 88, "#8b6b4f", "City Center"),
  officeBldg("bank-tower", 700, 982, 96, 96, "#76604a", "Bank Tower"),
  officeBldg("commerce-hall", 920, 984, 112, 92, "#9b7b5b", "Commerce Hall"),
  officeBldg("canal-offices", 1280, 982, 104, 90, "#6f5b4b", "Canal Offices"),
  officeBldg("brown-block", 1495, 986, 96, 88, "#8c6548", "Brown Block"),
  officeBldg("river-exchange", 1700, 982, 116, 96, "#7a553d", "River Exchange"),
  brickBldg("carytown", 500, 1260, 104, 60, "#a07040", "Carytown"),
  brickBldg("kuba-kuba", 700, 1262, 86, 58, "#b74e32", "Kuba Kuba"),
  brickBldg("village-cafe", 920, 1258, 84, 56, "#c4855a", "Village Café"),
  brickBldg("the-jasper", 1280, 1260, 88, 58, "#4e3b2e", "The Jasper"),
  brickBldg("brenner-pass", 1495, 1264, 98, 60, "#8d5c3e", "Brenner Pass"),
  brickBldg("buz-and-neds", 1700, 1260, 108, 60, "#7a3b1e", "Buz and Ned's"),
];

const corpRow: Entity[] = [
  corpBldg("carmax",          470,  835, 108, 82, "#1a1a2e", "#c62828", "CarMax",          "CarMax"),
  corpBldg("dominion-energy", 820,  835, 116, 86, "#0d1b3e", "#1565c0", "Dominion Energy", "Dominion Energy"),
];

const bgBuildings: Entity[] = [
  bgBldg("bg-west-1",  365,  845,  58, 48, "#4a3728"),
  bgBldg("bg-west-2",  930,  845,  52, 44, "#3b4a2e"),
  bgBldg("bg-mid-1",  1285, 1350,  64, 52, "#2e3a4a"),
  bgBldg("bg-mid-2",  1470, 1350,  54, 46, "#4a3a2e"),
  bgBldg("bg-mid-3",  1695, 1370,  60, 48, "#3a2e4a"),
  bgBldg("bg-south-1",  460, 1440,  56, 44, "#2e4a3a"),
  bgBldg("bg-south-2",  760, 1440,  66, 50, "#4a4a2e"),
];

const houses: Entity[] = [
  brickBldg("shrey-house", 1510, 1565, 92, 62, "#6d4c41", "Shrey's House"),
  brickBldg("sanjana-house", 1725, 1490, 96, 64, "#8d6e63", "Sanjana's House"),
];
